...
async def invite_link(client: app, message: Message):  # type: ignore
    try:
        ...
        chat = await app.get_chat_member( message.chat.id , app.me.id)
        
        # Ensure the bot is an admin to fetch the invite link
        if not chat.privileges.can_invite_users:
...
@app.on_message(filters.command("adminlist", prefixes=c.COMMAND_PREFIXES) & filters.group)
...
# /setgtitle command
@app.on_message(filters.command("setgtitle", prefixes=c.COMMAND_PREFIXES) & filters.group)
@error
@save
...
# /setgpic command
@app.on_message(filters.command("setgpic", prefixes=c.COMMAND_PREFIXES) & filters.group & filters.reply)
@error
@save
async def set_group_photo(client: app, message: Message): # type: ignore
    ...
    try:
        ...
        # Use the photo keyword argument
        await app.set_chat_photo(chat_id=message.chat.id, photo=photo_path)
...
# /rmgpic command
@app.on_message(filters.command("rmgpic", prefixes=c.COMMAND_PREFIXES) & filters.group)
@error
@save
...
# /setdesc command
@app.on_message(filters.command("setdesc", prefixes=c.COMMAND_PREFIXES) & filters.group)
@error
@save
...
# Command: /setrule
@app.on_message(filters.command("setrule", prefixes=c.COMMAND_PREFIXES) & filters.group)
@chatadmin
@error
@save
...
# Command: /rules
@app.on_message(filters.command("rules", prefixes=c.COMMAND_PREFIXES) & filters.group)
@error
@save
...
# Command: /clearrule
@app.on_message(filters.command("clearrule", prefixes=c.COMMAND_PREFIXES) & filters.group)
@chatadmin
@error
@save
...
@app.on_message(filters.command("userlist", prefixes=c.COMMAND_PREFIXES) & filters.group)
@chatadmin
@error
@save
