...
async def set_log_channel_command(client: Client, message: Message):
    ...
    # Ask user to forward a message from the log channel
    await message.reply_text(
        "𝖴𝗇𝖽𝖾𝗋𝗌𝗍𝗈𝗈𝖽! 𝖯𝗅𝖾𝖺𝗌𝖾 𝗆𝖺𝗄𝖾 𝗆𝖾 𝖺𝗇 𝖺𝖽𝗆𝗂𝗇 𝗂𝗇 𝗍𝗁𝖾 𝖽𝖾𝗌𝗂𝗋𝖾𝖽 𝗅𝗈𝗀 𝖼𝗁𝖺𝗇𝗇𝖾𝗅. 𝖮𝗇𝖼𝖾 𝖽𝗈𝗇𝖾, "
        "𝗌𝖾𝗇𝖽 𝖺𝗇𝗒 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 𝗍𝗈 𝗍𝗁𝖺𝗍 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 𝖺𝗇𝖽 𝖿𝗈𝗋𝗐𝖺𝗋𝖽 𝗂𝗍 𝗁𝖾𝗋𝖾."
    )

    # Wait for a forwarded message
    try:
        forwarded_msg : Message = await client.ask(
            chat_id=chat_id,
            text="𝖯𝗅𝖾𝖺𝗌𝖾 𝖿𝗈𝗋𝗐𝖺𝗋𝖽 𝖺 𝗆𝖾𝗌𝗌𝖺𝗀𝖾 𝖿𝗋𝗈𝗆 𝗍𝗁𝖾 𝖽𝖾𝗌𝗂𝗋𝖾𝖽 𝗅𝗈𝗀 𝖼𝗁𝖺𝗇𝗇𝖾𝗅.",
            filters=filters.forwarded & filters.user(user_id),
            timeout=300  # 5 minutes timeout
        )
    except Exception as e:
        await message.reply_text("𝖳𝗂𝗆𝖾𝗈𝗎𝗍 𝗋𝖾𝖺𝖼𝗁𝖾𝖽. 𝖯𝗅𝖾𝖺𝗌𝖾 𝗍𝗋𝗒 𝖺𝗀𝖺𝗂𝗇 𝗐𝗂𝗍𝗁 /𝗌𝖾𝗍𝗅𝗈𝗀.")
        return

    # Extract the original chat ID from the forwarded message
    original_chat_id = forwarded_msg.forward_from_chat.id if forwarded_msg.forward_from_chat else None
    ...
    await message.reply_text(
        f"𝖲𝗎𝖼𝖼𝖾𝗌𝗌𝖿𝗎𝗅𝗅𝗒 𝗌𝖾𝗍 𝗍𝗁𝖾 𝗅𝗈𝗀 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 𝖿𝗈𝗋 𝗍𝗁𝗂𝗌 𝖼𝗁𝖺𝗍 𝗍𝗈 {forwarded_msg.forward_from_chat.title}."
    )
 ...
 ✧ 𝖮𝗇𝖼𝖾 𝖺 𝗅𝗈𝗀 𝖼𝗁𝖺𝗇𝗇𝖾𝗅 𝗂𝗌 𝗌𝖾𝗍, 𝗍𝗁𝖾 𝖻𝗈𝗍 𝗐𝗂𝗅𝗅 𝗅𝗈𝗀 𝗄𝖾𝗒 𝖾𝗏𝖾𝗇𝗍𝗌 𝗂𝗇 𝗍𝗁𝖾 𝗀𝗋𝗈𝗎𝗉 𝗍𝗈 𝗍𝗁𝖾 𝗅𝗂𝗇𝗄𝖾𝖽 𝖼𝗁𝖺𝗇𝗇𝖾𝗅.
  ✧ 𝖫𝗈𝗀𝗀𝖾𝖽 𝖾𝗏𝖾𝗇𝗍𝗌 𝗂𝗇𝖼𝗅𝗎𝖽𝖾:
    - 𝖬𝖾𝗆𝖻𝖾𝗋𝗌 𝗃𝗈𝗂𝗇𝗂𝗇𝗀 𝗈𝗋 𝗅𝖾𝖺𝗏𝗂𝗇𝗀 𝗍𝗁𝖾 𝗀𝗋𝗈𝗎𝗉.
     - 𝖮𝗍𝗁𝖾𝗋 𝖺𝖽𝗆𝗂𝗇𝗂𝗌𝗍𝗋𝖺𝗍𝗂𝗏𝖾 𝖺𝖼𝗍𝗂𝗏𝗂𝗍𝗂𝖾𝗌 (𝗂𝖿 𝖼𝗈𝗇𝖿��𝗀𝗎𝗋𝖾𝖽).
 """
