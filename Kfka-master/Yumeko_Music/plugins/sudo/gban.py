...
from Yumeko_Music.utils import get_readable_time
...
@app.on_message(filters.command(["gban", "xban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["xunban", "ungban"]) & SUDOERS)
@language
...
@app.on_message(filters.command(["gbanned", "xbanned"]) & SUDOERS)
@language
