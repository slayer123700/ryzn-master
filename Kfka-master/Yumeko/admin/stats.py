...
async def stats(client: Client, message: Message):
    ...
    await message.reply_text(main_stats_message, reply_markup=buttons, disable_web_page_preview=False)
...
async def show_version_stats(client: Client, callback_query : CallbackQuery):
    ...
    await callback_query.message.edit_text(version_stats_message, reply_markup=buttons, disable_web_page_preview=False)
...
async def show_main_stats(client: Client, callback_query : CallbackQuery):
    ...
    await callback_query.message.edit_text(main_stats_message, reply_markup=buttons, disable_web_page_preview=False)