...
@app.on_message(filters.command(["look", "grs", "reverse", "find"] , prefixes=config.COMMAND_PREFIXES))
@error
@save
...
- **𝖢𝗈𝗆𝗆𝖺𝗇𝖽𝗌:**
 ✧ `/find`, `/𝗀𝗋𝗌`, `/𝗋𝖾𝗏𝖾𝗋𝗌𝖾`, 𝗈𝗋 `/look` **:** 𝖱𝖾𝗉𝗅𝗒 𝗍𝗈 𝖺𝗇 𝗂𝗆𝖺𝗀𝖾, 𝗌𝗍𝗂𝖼𝗄𝖾𝗋, 𝗈𝗋 𝗌𝗎𝗉𝗉𝗈𝗋𝗍𝖾𝖽 𝗆𝖾𝖽𝗂𝖺 𝗍𝗒𝗉𝖾 𝗍𝗈 𝗉𝖾𝗋𝖿𝗈𝗋𝗆 𝖺 𝖦𝗈𝗈𝗀𝗅𝖾 𝖱𝖾𝗏𝖾𝗋𝗌𝖾 𝖨𝗆𝖺𝗀𝖾 𝖲𝖾𝖺𝗋𝖼𝗁.
