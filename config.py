...
class config:
    ...
    START_STICKER_FILE_ID = [
        ...
        "CAACAgIAAxkBAAEPI65om1xGECE7_Wcn0jCQ90pK4bnUcAACIFYAAp7OCwABulJc1fwJZ282BA",
    ]

    # ========================== GIT INFO ========================== #
    GIT_USERNAME = "Senpaiii10"
    GIT_URL_WITH_TOKEN = "https://ghp_2BDb6sHDI9a8HtuUYi3HK2utCgqWdw1hjWkp@github.com/john-wick00/Yumeko.git"
...
LOG_GROUP_ID = "pookielog"  # ✅ Your music log channel ID
...
# Image URLs for various features
START_IMG_URL = config.START_IMG_URL
PING_IMG_URL = "https://files.catbox.moe/b8hocs.jpg"
PLAYLIST_IMG_URL = "https://files.catbox.moe/hx2fpa.jpg"
