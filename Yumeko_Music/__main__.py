...
import config
from Yumeko_Music import LOGGER, app, userbot
from Yumeko_Music.core.call import Aviax
from Yumeko_Music.misc import sudo
from Yumeko_Music.plugins import ALL_MODULES
from Yumeko_Music.utils.database import get_banned_users, get_gbanned
...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("Yumeko_Music.plugins" + all_module)
