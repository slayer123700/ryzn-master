...
from Yumeko_Music.utils.database import blacklist_chat, blacklisted_chats, whitelist_chat
...
@app.on_message(
    filters.command(["mwhitelistchat", "unblacklistchat", "unblchat"]) & SUDOERS
)
@language
...
@app.on_message(filters.command(["blacklistedchat", "blacklistedchats"]) & ~BANNED_USERS)
@language
