...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("Yumeko_Music/assets/font2.ttf", 30)
        font = ImageFont.truetype("Yumeko_Music/assets/font.ttf", 30)
        title_font = ImageFont.truetype("Yumeko_Music/assets/font3.ttf", 45)
        ...
        play_icons = Image.open("Yumeko_Music/assets/play_icons.png")
